...
public class InitializingBean {
	...
	public static void main(String[] args) {
		...
		Account account1 = new Account(100000,12,5,statement, SBI, customer1);		//@account to statement--> one to many[5]
		Account account2 = new Account(25698,30,2,statement,Axix, customer2);		//@account to customer--> many to one[6]
		Account account3 = new Account(256568,30,8,statement,Axix, customer3);
