...
public class ContollerMain {
	...
	public static void main(String[] args) {
		...
		CustomerService dao= context.getBean("customerService",service.CustomerServiceImpl.class);  
	...
	*/
		...
		// System.out.println(status5);
		 ...
		 //SupplierService sdao =(SupplierServiceImpl) context.getBean("supplierService");		//goods bean + jdbc template
