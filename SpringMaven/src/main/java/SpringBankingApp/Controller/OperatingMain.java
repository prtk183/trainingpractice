...
import SpringBankingApp.DAO.InitializingBean;
...
public class OperatingMain extends InitializingBean {
...
/*contactsMap*/
		...
		Customer customer1 = (Customer) context.getBean("customer1", SpringBankingApp.Model.Customer.class);
		Customer customer2 = (Customer) context.getBean("customer2", SpringBankingApp.Model.Customer.class);
...
/*account map*/		
	...
	//all the operations:
		...
		//@create bank
		Object o;
		o=op1.createBank("prtk", customersMap, contactsMap, accountsMap);
		...
		/*
		op1.createAccountForCustomer("Shiv", "Shankar", "SBI",
				584688, 123456789L, "shivsahnkar@gmail.com", 
				"ramdas road", "574ll", "447588", "Amaravati", contactsMap, accountsMap);
		
		op1.createAccountForCustomer("Prateek", "Shankar", "SBI",
